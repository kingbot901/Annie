    ...
    const pages = [
        ...
        <StoryPage key="cover" backgroundColor="bg-gradient-to-br from-rose-200 to-purple-200">
            <div className="flex flex-col items-center justify-center h-full text-center">
                ...
                <div className="text-2xl md:text-3xl text-purple-700 mb-8 relative z-10">
                    Hey Quratulain, you are<br />my<FlipWords words={['Begam g', 'Moi-cutie-pie', 'everything', 'love', 'world']} className="text-nowrap" />
                </div>
                <motion.button
        ...
        <StoryPage key="journey" backgroundColor="bg-gradient-to-br from-blue-200 to-green-200">
            ...
            <div className="space-y-4 flex-1 overflow-y-auto overflow-x-hidden rounded-xl custom-scrollbar">
                {[
                    { date: '14 May, 2024', event: 'Our Journey Began', emoji: '❤️' },
                    { date: '1 March, 2022', event: 'Inshallah Soon', emoji: '🎬' },
                    { date: 'Inshallah Soon as possible', event: 'First Hug', emoji: '🤗' },
                    { date: 'Hyeeeee zaroor ik din', event: 'First Trip Together', emoji: '✈️' },
                    { date: '27 November 2024', event: 'First Fight & Patch-up', emoji: '💬' },
                    { date: 'On pending', event: 'First Christmas Together', emoji: '🎄' },
                ]
                    .map((item, index) => (
                        <motion.div
                            key={index}
